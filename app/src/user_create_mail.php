...
$message = '<div style=' . '"' . 'width: 100%; text-align: center; font-weight: bold' . '"' . '></br><center><i><B>'.$_POST['login'].' : Vous venez de vous inscrire sur le site Camagru !</B></i></center></br></br></br></br></BR><HR/><div style="width: 100%; text-align: right">&copy;Camagru.fr</div>';
