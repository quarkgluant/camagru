...
<body>
  ...
  <nav>
    ...
    <form method="post" action="javascript:decor()"><select id="decor"><option value="./../../../public/img/decor/Butterfly.jpeg">Butterfly.jpeg</option><option value="./../../../public/img/decor/Dog.jpeg">Dog.jpeg</option><option value="./../../../public/img/decor/Fingerprint.jpeg">Fingerprint.jpeg</option><option value="./../../../public/img/decor/Fly.jpeg">Fly.jpeg</option><option value="./../../../public/img/decor/Glasses.jpeg">Glasses.jpeg</option><option value="./../../../public/img/decor/Hand-Butterfly.jpeg">Hand-Butterfly.jpeg</option><option value="./../../../public/img/decor/Idea.jpeg">Idea.jpeg</option><option value="./../../../public/img/decor/Iphone.png">Iphone.png</option><option value="./../../../public/img/decor/Loupe.jpeg">Loupe.jpeg</option><option value="./../../../public/img/decor/Plume.jpeg">Plume.jpeg</option><option value="./../../../public/img/decor/Unlike.jpeg">Unlike.jpeg</option><option value="./../../../public/img/decor/Valentin.png">Valentin.png</option><option value="./../../../public/img/decor/WakeUp.jpeg">WakeUp.jpeg</option></select><input type="submit" value="Afficher le décor choisi" /></form></br></br>Vous avez le choix entre <strong>13</strong> décors différents    <td>
     <div id="container3">
